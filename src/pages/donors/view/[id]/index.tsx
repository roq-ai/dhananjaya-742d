        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Kyc" text={data?.kyc} />

                <FormListItem label="Pan No" text={data?.pan_no} />

                <FormListItem label="Aadhar Number" text={data?.aadhar_number} />
